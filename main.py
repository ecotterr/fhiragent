...
from config.config import ApprovalPolicy, Config, OpenAIModel
...
class CLI:
    ...
    async def _handle_command(self, command: str) -> bool:
        ...
        if cmd_name == "/exit" or cmd_name == "/quit":
            ...
            console.print(f"  Base FHIR URL: {self.config.fhir.base_url}")
            console.print(f"  FHIR Schema: {self.config.fhir.fhir_schema}")
        elif cmd_name == "/model":
            if cmd_args:
                try:
